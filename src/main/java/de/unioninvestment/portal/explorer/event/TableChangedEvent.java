...
public class TableChangedEvent implements Event<TableChangedEventHandler> {
	
	public String newDirectory;
	
	

	public TableChangedEvent(String pDir){
		newDirectory = pDir;
	}
	...
	@Override
	public void dispatch(TableChangedEventHandler eventHandler) {
